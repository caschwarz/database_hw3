To run the packet simulator for part 1, you can run "python main.py" and the simulator will run until it has acknowledged the given number of packets in the code.
